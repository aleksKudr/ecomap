  ...
  var e = t.Class.extend({
    ...
    onAdd: function (e) {
      (this._map = e),
        ...
        t.Browser.touch &&
          !this.options.noHide &&
          (t.DomEvent.on(this._container, 'click', this.close, this), e.on('click', this.close, this));
    },
    onRemove: function (t) {
      this._pane.removeChild(this._container),
        t.off({ zoomanim: this._zoomAnimation, moveend: this._onMoveEnd, viewreset: this._onViewReset }, this),
    ...
    close: function () {
      ...
      e &&
        (t.Browser.touch &&
          !this.options.noHide &&
          (t.DomEvent.off(this._container, 'click', this.close), e.off('click', this.close, this)),
        e.removeLayer(this));
    },
    ...
    _initLayout: function () {
      (this._container = t.DomUtil.create('div', 'leaflet-label ' + this.options.className + ' leaflet-zoom-animated')),
    ...
    _setPosition: function (e) {
      ...
      'right' === a || ('auto' === a && s.x < o.x)
        ? (t.DomUtil.addClass(n, 'leaflet-label-right'), t.DomUtil.removeClass(n, 'leaflet-label-left'), (e = e.add(h)))
    ...
    _initInteraction: function () {
      if (this.options.clickable) {
        ...
        for (var n = 0; i.length > n; n++) t.DomEvent.on(e, i[n], this._fireMouseEvent, this);
      }
    },
    _removeInteraction: function () {
      if (this.options.clickable) {
        ...
        for (var n = 0; i.length > n; n++) t.DomEvent.off(e, i[n], this._fireMouseEvent, this);
      }
    },
    ...
    _fireMouseEvent: function (e) {
      this.fire(e.type, { originalEvent: e }),
        'contextmenu' === e.type && this.hasEventListeners(e.type) && t.DomEvent.preventDefault(e),
        'mousedown' !== e.type ? t.DomEvent.stopPropagation(e) : t.DomEvent.preventDefault(e);
    }
  });
  return (
    (t.BaseMarkerMethods = {
      ...
      bindLabel: function (i, n) {
        var o = this.options.icon ? this.options.icon.options.labelAnchor : this.options.labelAnchor,
    ...
    t.Path.include({
      bindLabel: function (i, n) {
        return (
          (this.label && this.label.options === n) || (this.label = new e(n, this)),
