...
!(function (t, i) {
  ...
  function rt(t, i, e) {
    var n = i || new x(0, 0);
    t.style[ce] =
      (Ri ? 'translate(' + n.x + 'px,' + n.y + 'px)' : 'translate3d(' + n.x + 'px,' + n.y + 'px,0)') +
      (e ? ' scale(' + e + ')' : '');
  }
  function at(t, i) {
  ...
  var fi,
    ...
    qi =
      !window.L_NO_TOUCH &&
      (Vi || 'ontouchstart' in window || (window.DocumentTouch && document instanceof window.DocumentTouch)),
    Gi = Wi && Zi,
    Ki = Wi && ki,
  ...
  var me,
    ...
    be = ci.extend({
      ...
      panInside: function (t, i) {
        ...
        if (!u.contains(r)) {
          ...
          var l = s.subtract(r),
            c = w(r.x + l.x, r.y + l.y);
          (r.x < u.min.x || r.x > u.max.x) && ((c.x = s.x - l.x), l.x > 0 ? (c.x += h.x - e.x) : (c.x -= h.x - n.x)),
            (r.y < u.min.y || r.y > u.max.y) && ((c.y = s.y - l.y), l.y > 0 ? (c.y += h.y - e.y) : (c.y -= h.y - n.y)),
    ...
    Te = v.extend({
      ...
      addTo: function (t) {
        ...
        return (
          Q(i, 'leaflet-control'), -1 !== e.indexOf('bottom') ? n.insertBefore(i, n.firstChild) : n.appendChild(i), this
        );
      },
      remove: function () {
        return this._map
          ? (K(this._container), this.onRemove && this.onRemove(this._map), (this._map = null), this)
          : this;
      },
      ...
      expand: function () {
        ...
        return (
          t < this._section.clientHeight
            ? (Q(this._section, 'leaflet-control-layers-scrollbar'), (this._section.style.height = t + 'px'))
    ...
    Re = ci.extend({
      ...
      finishDrag: function () {
        tt(document.body, 'leaflet-dragging'),
          this._lastTarget && (tt(this._lastTarget, 'leaflet-drag-target'), (this._lastTarget = null));
    ...
    Ke = Ge.extend({
      addLayer: function (t) {
        return this.hasLayer(t)
          ? this
          : (t.addEventParent(this), Ge.prototype.addLayer.call(this, t), this.fire('layeradd', { layer: t }));
      },
      removeLayer: function (t) {
        return this.hasLayer(t)
  ...
  var an = Xt,
    ...
    ln = qe.extend({
      ...
      onRemove: function (t) {
        t._fadeAnimated
          ? (nt(this._container, 0), (this._removeTimeout = setTimeout(e(K, void 0, this._container), 200)))
          : K(this._container);
      },
      getLatLng: function () {
        return this._latlng;
  ...
  var pn = qe.extend({
      ...
      _removeTile: function (t) {
        var i = this._tiles[t];
        i &&
          (K(i.el), delete this._tiles[t], this.fire('tileunload', { tile: i.el, coords: this._keyToTileCoords(t) }));
      },
  ...
  var gn = qe.extend({
    ...
    vn = gn.extend({
      ...
      _requestRedraw: function (t) {
        this._map &&
          (this._extendRedrawBounds(t), (this._redrawRequest = this._redrawRequest || f(this._redraw, this)));
      },
        ...
        (o.stroked = !!n.stroke),
          ...
          n.stroke
            ? (i || (i = t._stroke = yn('stroke')),
              ...
              (i.opacity = n.opacity),
              n.dashArray
                ? (i.dashStyle = oi(n.dashArray) ? n.dashArray.join(' ') : n.dashArray.replace(/( *, *)/g, ' '))
                : (i.dashStyle = ''),
  ...
  var bn = Ee.extend({
    ...
    _onMouseDown: function (t) {
      ...
      this._clearDeferredResetState(),
        ...
        mt(
          document,
          { contextmenu: Lt, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown },
          this
        );
    },
    _onMouseMove: function (t) {
