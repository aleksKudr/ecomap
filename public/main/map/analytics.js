...
*/
  ...
  function Pa(a) {
    ...
    ue.map(function (c, d) {
      d.F &&
        ((c = a.get(c)),
        void 0 != c && c != d.defaultValue && ('boolean' == typeof c && (c *= 1), b.push(d.F + '=' + K('' + c))));
    });
    ...
    switch (P(a, ad)) {
      ...
      default:
        b
          ? ((c = P(a, Ra)),
            (d = (d = a.Z(Ia)) || ua),
            'image' == b ? wc(e, c, d) : ('xhr' == b && wd(e, c, d)) || ('beacon' == b && x(e, c, d)) || ba(e, c, d))
          : ba(e, P(a, Ra), a.Z(Ia));
    }
    e = P(a, Na);
    e = h(e);
      ...
      if (!a.get(Qe) && (a.set(Qe, !0), !a.get('&gtm'))) {
        ...
        if (b) {
          O['google.tagmanager.debugui2.queue'] ||
            ((O['google.tagmanager.debugui2.queue'] = []), Id('https://www.google-analytics.com/debug/bootstrap'));
      ...
      if ('cookie' == P(a, ac)) {
        ...
        if (a.get(je)) {
          if ((b = P(a, ce))) {
            ...
            g && 'aw.ds' != g
              ? d && (d.ua = !0)
              : ((b = ['1', e, Cc(b)].join('.')), 0 <= c && (d && (d.ta = !0), zc('_gac_' + Cc(k), b, ca, l, k, c, w)));
            le(d);
          }
        } else J(75);
        a.get(je) &&
      ...
      1 === e
        ? ((g.ia = !!a.get('anonymizeIp')),
          ...
          G(String(a.get('trackingId'))) ||
            ...
            (g.qa = E(P(a, kb), 'gclid'))))
        : 2 === e &&
          ((g.context = 'c'), (ca = { allow_google_signals: a.get(Ud), allow_ad_personalization_signals: a.get(xe) }));
      He(g, ca);
      return t(g);
    };
  var H = {},
    ...
    Ne = function (a) {
      return (
        !H[P(a, Na)] && void 0 === a.get('&gtm') && void 0 === a.get(fa) && void 0 === a.get(gd) && void 0 === a.get(oe)
      );
    },
    re = function (a, b) {
      var c = new ee(),
          ...
          if ((c && e && J(36), a.get(bc) || ye(a.get(Kd)) || g)) {
            if (
              ...
              ca
                ...
                : l && (e = l.split('.')) && 2 === e.length && (J(37), a.data.set(ce, e[0]), a.data.set(fe, e[1])),
