...
butWinHere = '<div class="blockForWindow">' +
...
let arrButNum = ['false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false', 'false'];
...
function initialize(e, left, right){
    ...
    if (e != 'select'){
        L.marker([56.19690433351169, 36.95694805333598], {icon: pointFirstDemo}).bindPopup("<strong>Эльдорадо</strong><br><br>Пункт приема электротехники и батареек в магазине Эльдорадо, Иное, Батарейки, Бытовая техника.<br><br><b>г. Солнечногорск, Красная улица 157</b>").addTo(mapnall);
        L.marker([56.194134874016584, 36.96790219495273], {icon: pointFirstDemo}).bindPopup("<strong>Перекресток</strong><br><br>Точка приема зубных щеток в магазине Перекресток, Иное.<br><br><b>г. Солнечногорск, Красная улица 15</b>").addTo(mapnall);
        L.marker([56.18014693407129, 36.95673347661434], {icon: pointFirstDemo}).bindPopup("<strong>Перекресток</strong><br><br>Точка приема зубных щеток в магазине Перекресток, Иное.<br><br><b>г. Солнечногорск, Обуховская улица с44А</b>").addTo(mapnall);
        L.marker([56.18626205236132, 36.97470427701376], {icon: pointFirstDemo}).bindPopup('<strong>Первый Экологический Сервис</strong><br><br>Контейнер для сбора опасных отходов от компании "Первый Экологический Сервис", Опасные отходы, Лампочки.<br><br><b>г. Солнечногорск, Почтовая улица, 9</b>').addTo(mapnall);
        L.marker([56.1889034569558, 36.976463806127306], {icon: pointFirstDemo}).bindPopup('<strong>Первый Экологический Сервис</strong><br><br>Контейнер для сбора опасных отходов от компании "Первый Экологический Сервис", Опасные отходы, Лампочки.<br><br><b>г. Солнечногорск, Красная улица, 120</b>').addTo(mapnall);
        L.marker([56.18735393467215, 36.98250414082844], {icon: pointFirstDemo}).bindPopup("<strong>ВкусВилл Батарейки</strong><br><br>Точка приема батареек в магазине ВкусВилл Батарейки.<br><br><b>г. Солнечногорск, ул. Дзержинского, д. 15А</b>").addTo(mapnall);
        L.marker([56.175434273986866, 36.99896217534477], {icon: pointFirstDemo}).bindPopup("<strong>ВкусВилл Батарейки</strong><br><br>Точка приема батареек в магазине ВкусВилл Батарейки.<br><br><b>г. Солнечногорск, Красная ул., д. 22А</b>").addTo(mapnall);
    }
    ...
    for (let i = 0; i < arrCoordinats.length; i++){
        ...
        L.marker([Number(arrCoordinats[i].coordinats.split(';')[0]), Number(arrCoordinats[i].coordinats.split(';')[1])], {icon: pointFirstDemo}).bindPopup(`<strong>${arrCoordinats[i].name_place}</strong><br><br>${arrCoordinats[i].discription}<br><br><b>${arrCoordinats[i].adress}</b>`).addTo(mapnall);
    }
    }, 2000);
    ...
    accept.onclick = function(e){let arrCoords = coords.value.split(';'); marker = L.marker([arrCoords[0], arrCoords[1]], {icon: pointFirstDemo}).bindPopup(discription.value).addTo(mapnall); modalOpenClosed('thanks'); saveDataPoint();}
